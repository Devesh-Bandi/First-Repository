...
def default_test():
    ...
    # Unloading cargo_weight 70 (more than load in the truck)
    truck.unload_cargo(cargo_weight=70)
    print(truck.load)  # 25 - 75 => 0 as load never be negative
    # Prints "Cannot load cargo more than max limit: 100"
    ...
    # Prints "Cannot load cargo during motion"
    truck.load_cargo(cargo_weight=40)
    # Prints "Cannot unload cargo during motion"
